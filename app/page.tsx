...
export const metadata: Metadata = {
  ...
  description:
    "A public Knox Signature wedding investment guide for cocktail hour, reception, and atmosphere review calls.",
  openGraph: {
    title: "Knox Signature Wedding Investment Guide",
    description: "Cocktail hour, reception, and atmosphere review call details.",
