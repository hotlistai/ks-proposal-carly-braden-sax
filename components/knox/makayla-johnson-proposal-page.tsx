...
const config = {
  coupleName: "Makayla & Johnson",
  eventDate: "November 12, 2026",
  venue: "The Springs at Valley View",
  totalInvestment: "$7,250",
...
const PREVIEW_VIDEO = "/videos/makayla-johnson-preview.mp4";
const PREVIEW_VIDEO_POSTER = "/videos/makayla-johnson-preview-poster.jpg";
const MIDDLE_VIDEO = "/videos/makayla-johnson-live-set.mp4";
const MIDDLE_VIDEO_POSTER = "/videos/makayla-johnson-live-set-poster.jpg";
...
const detailCards = [
  ...
  { label: "Ceremony", value: "Chapel coverage + cueing" },
  { label: "Reception", value: config.venue },
  { label: "Performance", value: "DJ-led set with live saxophone integration" },
];

const ceremonyItems = [
  "Wireless speaker coverage for the ceremony",
  "Wireless lapel microphone for officiant",
  "Wireless lapel microphone for groom",
  "Recorded ceremony music and cueing for processional, recessional, and key moments",
  "Optional live saxophone accents for select moments if desired",
  "Clean, discreet setup that complements the chapel",
];

const cocktailItems = [
  "Live saxophone and piano performance",
  "Frank Sinatra classics and timeless cocktail-style music",
  "A welcoming, elevated atmosphere as guests transition from ceremony",
  "Music designed to feel social, relaxed, and memorable",
  "Sound coverage tailored to the cocktail space",
];

const dinnerItems = [
  "DJ-led music selection that supports conversation and the room",
  "Emcee coverage for introductions, announcements, and key moments",
  "Seamless handling of toasts using wireless microphones",
  "Select live accents to complement important moments",
];

const danceItems = [
  "DJ-led dance set",
  "Live saxophone integration later in the evening",
        ...
        <FadeIn delay={150}>
          ...
          >
            ...
            <p>
              ...
              excited to design an atmosphere that carries the day naturally from ceremony in the chapel through
              cocktail hour and into the reception.
            </p>
    ...
    >
      ...
      <FadeIn delay={175}>
        <p className="mt-8 max-w-[64ch] font-light" style={{ color: "rgba(255,255,255,0.72)", lineHeight: 1.75 }}>
          The day begins with a clean, intentional ceremony setting, followed by a smooth transition into cocktail
          hour and a reception that builds naturally in energy throughout the night.
        </p>
      </FadeIn>

      <FadeIn delay={250}>
        <div className="mt-10">
          <SectionLabel>Ceremony - Chapel</SectionLabel>
...
function CocktailHourSection() {
  return (
    ...
    >
      ...
      <FadeIn delay={175}>
        <ul className="mt-8 my-0 max-w-[64ch] list-none p-0">
      ...
      <FadeIn delay={250}>
        <div className="mt-12">
          <p className="max-w-[64ch] font-light" style={{ color: "rgba(255,255,255,0.72)", lineHeight: 1.75 }}>
            As the dance floor opens, the evening transitions into a DJ-led set, with live saxophone entering later
            in the dance portion for a more intentional wow moment.
          </p>
        </div>
      </FadeIn>
    </section>
    ...
    >
      ...
      <FadeIn delay={125}>
        <p className="mt-10 max-w-[66ch] font-light" style={{ color: "rgba(255,255,255,0.58)", lineHeight: 1.75 }}>
          Everything is designed to look as polished as it sounds and to complement each space throughout the day.
        </p>
      </FadeIn>
...
export function MakaylaJohnsonProposalPage() {
  return (
    <>
      <Header />
      <EventSnapshot />
